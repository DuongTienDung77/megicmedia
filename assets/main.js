...
const generateImage = async (parts) => {
  const response = await ai.models.generateContent({
...
const generateImageFromText = async (prompt, negativePrompt, config) => {
...
const generateVideo = async (prompt, imagePart = null, quality, aspectRatio) => {
    const request = {
    ...
    const response = await fetch(`${downloadLink}&key=${window.GEMINI_API_KEY}`);
    if (!response.ok) {
...
const Header = () => {
  ...
  return (
    _jsxs("header", { className: "bg-light-surface dark:bg-dark-surface shadow-md p-4 flex justify-between items-center border-b border-light-border dark:border-dark-border", children: [
      _jsxs("h1", { className: "text-xl font-bold text-light-text dark:text-dark-text", children: ["✨ ", t('appName')] }),
      _jsxs("div", { className: "flex items-center space-x-4", children: [
        _jsx("button", { onClick: toggleTheme, title: t('toggleTheme'), className: "text-light-text dark:text-dark-text text-xl", children: 
          _jsx("i", { className: `fa-solid ${theme === 'light' ? 'fa-moon' : 'fa-sun'}` })
         }),
        _jsxs("div", { className: "relative", children: [
          _jsx("i", { className: "fa-solid fa-globe text-light-text dark:text-dark-text absolute top-1/2 left-3 -translate-y-1/2" }),
          _jsxs("select", { 
            value: language, 
            ...
            children: [
              ...
              _jsx("option", { value: "vi", children: "Tiếng Việt" })] })] })] })] })
  );
};

const Spinner = () => (
  _jsx("div", { className: "flex justify-center items-center h-full", children: 
    _jsx("div", { className: "animate-spin rounded-full h-16 w-16 border-t-2 border-b-2 border-light-primary dark:border-dark-primary" })
   })
);
...
const ImageUploader = ({ onImageUpload, label }) => {
  ...
  return (
    _jsxs("div", { children: [
      _jsx("label", { className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: label }),
      _jsx("div", { 
        ...
        children: image ? (
          _jsx("img", { src: image, alt: "Uploaded preview", className: "max-w-full h-auto rounded-md" })
        ) : (
          _jsxs(_Fragment, { children: [
            _jsx("i", { className: "fas fa-cloud-upload-alt text-4xl text-gray-400 mb-2" }),
            _jsx("p", { className: "text-gray-500 dark:text-gray-400", children: t('dragOrClick') })] })
        ) }),
      _jsx("input", { 
        type: "file", 
        ref: fileInputRef, 
...
const ImageComparator = ({ beforeSrc, afterSrc }) => {
    ...
    return (
        _jsxs("div", { ref: containerRef, className: "image-comparator select-none", children: [
            _jsx("img", { src: beforeSrc, alt: "Before", className: "comparator-img-before", draggable: "false" }),
            _jsx("div", { className: "comparator-after", style: { clipPath: `polygon(0 0, ${sliderPosition}% 0, ${sliderPosition}% 100%, 0 100%)` }, children: 
                _jsx("img", { src: afterSrc, alt: "After", className: "comparator-img-after", draggable: "false" })
             }),
            _jsx("div", { 
                ...
                children: 
                _jsx("div", { className: "comparator-handle", children: 
                    _jsx("i", { className: "fas fa-arrows-alt-h text-white" })
                 })
             })] })
    );
};
...
const ToolCard = ({ icon, title, description, onClick }) => (
  _jsxs("div", { 
    ...
    onClick: onClick, 
    children: [
      _jsx("div", { className: "text-2xl text-light-primary dark:text-dark-primary mb-4", children: 
        _jsx("i", { className: `fas ${icon}` })
       }),
      _jsx("h3", { className: "text-xl font-bold mb-2 text-light-text dark:text-dark-text", children: title }),
      _jsx("p", { className: "text-gray-600 dark:text-gray-400", children: description })] })
);
...
const ToolInfo = ({ toolKey }) => {
    ...
    return (
        _jsxs("div", { className: "mb-6", children: [
            _jsx("div", { className: "flex border-b-2 border-light-bg dark:border-dark-bg", children: 
                tabs.map(tab => (
                    _jsxs("button", { 
                        ...
                        children: [
                          _jsx("i", { className: `fas ${tab.icon} mr-2` }), 
                          tab.label] }, tab.id)
                ))
             }),
            _jsx("div", { className: "py-4 text-sm text-light-text dark:text-dark-text", children: 
                _jsx("ul", { className: "list-disc pl-5 space-y-1", children: 
                    Array.isArray(currentContent) && currentContent.map((item, index) => _jsx("li", { children: item }, index))
                 })
             })] })
    );
};
...
const ToggleSwitch = ({ id, checked, onChange, disabled, label, description }) => (
    _jsxs("div", { className: "flex items-center justify-between bg-light-bg dark:bg-dark-bg p-3 rounded-lg border border-light-border dark:border-dark-border", children: [
        _jsxs("div", { children: [
            _jsx("label", { htmlFor: id, className: "block text-sm font-bold text-light-text dark:text-dark-text cursor-pointer select-none", children: label }),
            description && _jsx("p", { className: "text-xs text-gray-500 select-none", children: description })] }),
        _jsx("label", { className: "relative inline-flex items-center cursor-pointer", children: [
            _jsx("input", { 
                type: "checkbox", 
                id: id, 
                checked: checked, 
...
const HomePage = ({ onNavigate }) => {
  ...
  return (
    _jsxs("div", { className: "p-8 animate-fade-in", children: [
      _jsxs("div", { className: "text-center mb-12", children: [
        _jsx("h2", { className: "text-5xl md:text-6xl font-extrabold mb-4 bg-gradient-to-r from-fuchsia-500 to-purple-600 bg-clip-text text-transparent", children: t('homeTitle') }),
        _jsx("p", { className: "text-xl text-gray-500 dark:text-gray-300 max-w-2xl mx-auto", children: t('homeSubtitle') })] }),
      _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: 
        tools.map((tool) => (
          _jsx(ToolCard, { 
            ...
            onClick: () => onNavigate(tool.page) }, tool.page)
        ))
       })] })
  );
};
...
const PoseStudio = ({ onBack }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const generatedImage = await callApi(() => generateImage(parts));
    ...
    return (
        _jsxs("div", { className: "p-4 md:p-8 animate-fade-in", children: [
            _jsxs("button", { onClick: onBack, className: "mb-6 flex items-center text-light-text dark:text-dark-text hover:underline", children: [
                _jsx("i", { className: "fas fa-arrow-left mr-2" }), " ", t('goBack')] }),
            _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8", children: [
                _jsxs("div", { className: "space-y-6 bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                    _jsx(ToolInfo, { toolKey: "pose" }),
                    _jsx(ImageUploader, { label: t('uploadCharacter'), onImageUpload: setCharacterImage }),
                    _jsx(ImageUploader, { label: t('uploadPose'), onImageUpload: setPoseImage }),
                    
                    _jsxs("div", { children: [
                        _jsx("label", { className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('preset') }),
                        _jsx("select", { value: preset, onChange: (e) => setPreset(e.target.value), className: "w-full p-2 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-md text-light-text dark:text-dark-text", children: 
                            Object.entries(PRESETS).map(([key, value]) => (
                                _jsx("option", { value: key, children: value.label[language] }, key)
                            ))
                         })] }),

                     _jsxs("div", { children: [
                        _jsx("label", { className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('aspectRatio') }),
                        _jsx("select", { value: aspectRatio, onChange: (e) => setAspectRatio(e.target.value), className: "w-full p-2 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-md text-light-text dark:text-dark-text", children: 
                           ASPECT_RATIOS.map(ratio => (_jsx("option", { value: ratio.value, children: ratio.label[language] }, ratio.value)))
                         })] }),

                    _jsxs("div", { children: [
                        _jsx("label", { className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('outputFormat') }),
                        _jsxs("select", { value: outputFormat, onChange: (e) => setOutputFormat(e.target.value), className: "w-full p-2 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-md text-light-text dark:text-dark-text", children: [
                           _jsx("option", { value: "image/jpeg", children: "JPEG" }),
                           _jsx("option", { value: "image/png", children: "PNG" }),
                           _jsx("option", { value: "image/webp", children: "WEBP" })] })] }),

                    _jsxs("div", { className: "flex items-center justify-between", children: [
                        _jsxs("label", { htmlFor: "beautify-toggle-pose", className: "block text-sm font-bold text-light-text dark:text-dark-text", children: [
                            t('beautify'),
                            !isBeautyAvailable && _jsxs("span", { className: "text-xs font-normal text-gray-500 ml-2", children: [t('beautifyHint')] })] }),
                        _jsx("label", { className: "relative inline-flex items-center cursor-pointer", children: [
                            _jsx("input", { 
                                type: "checkbox", 
                    ...
                    _jsxs("div", { children: [
                      _jsx("label", { className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('controlMode') }),
                        _jsx("div", { className: "flex space-x-2 rounded-lg p-1 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border", children: 
                            CONTROL_MODES.map((mode) => (
                                ...
                                children: 
                                t(`controlMode${mode}`) }, mode)
                            ))
                         }),
                        _jsx("p", { className: "mt-2 text-xs text-center text-gray-500 dark:text-gray-400 min-h-[2.5em] px-1", children: 
                          t(`controlModeDesc_${controlMode}`)
                         })] }),

                    _jsxs("div", { children: [
                      _jsx("label", { htmlFor: "positivePrompt", className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('positivePrompt') }),
                      _jsx("textarea", { 
                          id: "positivePrompt", 
                    ...
                    _jsxs("div", { children: [
                      _jsx("label", { htmlFor: "negativePrompt", className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('negativePrompt') }),
                      _jsx("textarea", { 
                          id: "negativePrompt", 
                ...
                _jsxs("div", { className: "space-y-6", children: [
                    _jsxs("div", { className: "bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                         _jsx("h3", { className: "text-xl font-bold mb-4 text-light-text dark:text-dark-text", children: t('result') }),
                         _jsx("div", { className: "w-full h-96 bg-light-bg dark:bg-dark-bg rounded-lg flex items-center justify-center border border-light-border dark:border-dark-border", children: 
                             isLoading ? _jsx(Spinner, {}) : resultImage && characterImage ? _jsx(ImageComparator, { beforeSrc: characterImage.dataUrl, afterSrc: resultImage }) : _jsx("p", { className: "text-gray-500", children: t('preview') })
                          }),
                         error && _jsx("p", { className: "text-red-500 mt-4", children: error })] }),
                    resultImage && !isLoading && (
                        _jsxs("a", { href: resultImage, download: getDownloadFilename(resultImage), className: "w-full btn-primary text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center", children: [
                            _jsx("i", { className: "fas fa-download mr-2" }), " ", t('download')] })
                    ),
                    _jsxs("button", { onClick: handleSubmit, disabled: isLoading, className: "w-full btn-primary text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed", children: [
                        _jsx("i", { className: "fas fa-cogs mr-2" }), " ", isLoading ? t('generating') : t('generate')] })] })] })] })
    );
};
...
const AIStylist = ({ onBack }) => {
    ...
    return (
        _jsxs("div", { className: "p-4 md:p-8 animate-fade-in", children: [
            ...
            _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8", children: [
                _jsxs("div", { className: "space-y-6 bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                    _jsx(ToolInfo, { toolKey: "stylist" }),
                    _jsx(ImageUploader, { label: t('uploadModel'), onImageUpload: setModelImage }),
                    _jsx(ImageUploader, { label: t('uploadOutfit'), onImageUpload: setOutfitImage }),
                    
                    _jsxs("div", { children: [
                        _jsx("label", { className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('preset') }),
                        _jsxs("select", { value: preset, onChange: (e) => setPreset(e.target.value), className: "w-full p-2 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-md text-light-text dark:text-dark-text", children: [
                            _jsx("option", { value: "auto-preset", children: t('autoPreset') }),
                            Object.entries(PRESETS).map(([key, value]) => (
                                _jsx("option", { value: key, children: value.label[language] }, key)
                            ))] })] }),
                    ...
                    _jsxs("div", { className: "flex items-center justify-between", children: [
                        _jsxs("label", { htmlFor: "beautify-toggle-stylist", className: "block text-sm font-bold text-light-text dark:text-dark-text", children: [
                            t('beautify'),
                            !isBeautyAvailable && _jsxs("span", { className: "text-xs font-normal text-gray-500 ml-2", children: [t('beautifyHint')] })] }),
                        _jsx("label", { className: "relative inline-flex items-center cursor-pointer", children: [
                            _jsx("input", { 
                    ...
                    _jsxs("div", { className: "bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                         ...
                         _jsx("div", { className: "w-full h-96 bg-light-bg dark:bg-dark-bg rounded-lg flex items-center justify-center border border-light-border dark:border-dark-border", children: 
                            isLoading ? (
                                ...
                                _jsx("img", { src: resultImage, alt: t('result'), className: "object-contain max-h-full max-w-full rounded-lg" })
                            ) : (
                                _jsx("p", { className: "text-gray-500", children: t('preview') })
                            )
                          }),
                         error && _jsx("p", { className: "text-red-500 mt-4", children: error })] }),
                    resultImage && !isLoading && (
...
const PropFusion = ({ onBack }) => {
    ...
    return (
        _jsxs("div", { className: "p-4 md:p-8 animate-fade-in", children: [
            _jsxs("button", { onClick: onBack, className: "mb-6 flex items-center text-light-text dark:text-dark-text hover:underline", children: [_jsx("i", { className: "fas fa-arrow-left mr-2" }), " ", t('goBack')] }),
            _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8", children: [
                _jsxs("div", { className: "space-y-6 bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                    _jsx(ToolInfo, { toolKey: "prop" }),
                    _jsx(ImageUploader, { label: t('uploadCharacter'), onImageUpload: setCharacterImage }),
                    _jsx(ImageUploader, { label: t('uploadProp'), onImageUpload: setPropImage }),
                    _jsxs("div", { children: [
                        _jsx("label", { className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('preset') }),
                        _jsx("select", { value: preset, onChange: (e) => setPreset(e.target.value), className: "w-full p-2 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-md text-light-text dark:text-dark-text", children: 
                            Object.entries(PRESETS).map(([key, value]) => (_jsx("option", { value: key, children: value.label[language] }, key)))
                         })] }),
                    ...
                    _jsxs("div", { className: "flex items-center justify-between", children: [
                        _jsxs("label", { htmlFor: "beautify-toggle-prop", className: "block text-sm font-bold text-light-text dark:text-dark-text", children: [
                            t('beautify'),
                            !isBeautyAvailable && _jsxs("span", { className: "text-xs font-normal text-gray-500 ml-2", children: [t('beautifyHint')] })] }),
                        _jsx("label", { className: "relative inline-flex items-center cursor-pointer", children: [
                            _jsx("input", { 
                    ...
                    _jsxs("div", { children: [
                      _jsx("label", { htmlFor: "positivePrompt", className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('positivePrompt') }),
                      _jsx("textarea", { id: "positivePrompt", value: positivePrompt, onChange: (e) => setPositivePrompt(e.target.value), placeholder: t('positivePromptPlaceholder'), rows: 3, className: "w-full p-2 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-md text-light-text dark:text-dark-text" })] }),
                    _jsxs("div", { children: [
                      _jsx("label", { htmlFor: "negativePrompt", className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('negativePrompt') }),
                      _jsx("textarea", { id: "negativePrompt", value: negativePrompt, onChange: (e) => setNegativePrompt(e.target.value), placeholder: t('negativePromptPlaceholder'), rows: 3, className: "w-full p-2 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-md text-light-text dark:text-dark-text" })] })] }),
                _jsxs("div", { className: "space-y-6", children: [
                    _jsxs("div", { className: "bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                         _jsx("h3", { className: "text-xl font-bold mb-4 text-light-text dark:text-dark-text", children: t('result') }),
                         _jsx("div", { className: "w-full h-96 bg-light-bg dark:bg-dark-bg rounded-lg flex items-center justify-center border border-light-border dark:border-dark-border", children: 
...
const AIDesign = ({ onBack }) => {
    ...
    return (
        _jsxs("div", { className: "p-4 md:p-8 animate-fade-in", children: [
            ...
            _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8", children: [
                _jsxs("div", { className: "space-y-6 bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                    _jsx(ToolInfo, { toolKey: "design" }),
                    _jsx(ImageUploader, { label: t('uploadSubject'), onImageUpload: setSubjectImage }),
                    _jsx(ImageUploader, { label: t('uploadBackground'), onImageUpload: setBackgroundImage }),
                    _jsxs("div", { children: [
                        _jsx("label", { className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('preset') }),
                        _jsx("select", { value: preset, onChange: (e) => setPreset(e.target.value), className: "w-full p-2 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-md text-light-text dark:text-dark-text", children: 
                            Object.entries(PRESETS).map(([key, value]) => (_jsx("option", { value: key, children: value.label[language] }, key)))
                    ...
                    _jsxs("div", { className: "flex items-center justify-between", children: [
                        _jsxs("label", { htmlFor: "beautify-toggle-design", className: "block text-sm font-bold text-light-text dark:text-dark-text", children: [
                            t('beautify'),
                            !isBeautyAvailable && _jsxs("span", { className: "text-xs font-normal text-gray-500 ml-2", children: [t('beautifyHint')] })] }),
                        _jsx("label", { className: "relative inline-flex items-center cursor-pointer", children: [
                            _jsx("input", { 
                ...
                _jsxs("div", { className: "space-y-6", children: [
                    _jsxs("div", { className: "bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                         _jsx("h3", { className: "text-xl font-bold mb-4 text-light-text dark:text-dark-text", children: t('result') }),
                         _jsx("div", { className: "w-full h-96 bg-light-bg dark:bg-dark-bg rounded-lg flex items-center justify-center border border-light-border dark:border-dark-border", children: 
                             isLoading ? _jsx(Spinner, {}) : resultImage && subjectImage ? _jsx(ImageComparator, { beforeSrc: subjectImage.dataUrl, afterSrc: resultImage }) : _jsx("p", { className: "text-gray-500", children: t('preview') })
                          }),
                         error && _jsx("p", { className: "text-red-500 mt-4", children: error })] }),
                    resultImage && !isLoading && (
                        _jsxs("a", { href: resultImage, download: getDownloadFilename(resultImage), className: "w-full btn-primary text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center", children: [
...
const AICreative = ({ onBack }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const generatedImage = await callApi(() => generateImageFromText(finalPrompt, negativePrompt, config));
            setResultImage(generatedImage);
        } catch (err) {
            console.error(err);
            setError(err.message || t('error'));
    ...
    return (
        _jsxs("div", { className: "p-4 md:p-8 animate-fade-in", children: [
            ...
            _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8", children: [
                _jsxs("div", { className: "space-y-6 bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                    _jsx(ToolInfo, { toolKey: "creative" }),
                    _jsxs("div", { children: [
                        _jsx("label", { htmlFor: "positivePrompt", className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('imagePrompt') }),
                        _jsx("textarea", { id: "positivePrompt", value: positivePrompt, onChange: (e) => setPositivePrompt(e.target.value), placeholder: t('imagePromptPlaceholder'), rows: 5, className: "w-full p-2 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-md text-light-text dark:text-dark-text" })] }),
                    _jsxs("div", { children: [
                        _jsx("label", { className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('preset') }),
                        _jsx("select", { value: preset, onChange: (e) => setPreset(e.target.value), className: "w-full p-2 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-md text-light-text dark:text-dark-text", children: 
                            Object.entries(PRESETS).map(([key, value]) => (_jsx("option", { value: key, children: value.label[language] }, key)))
                     ...
                     _jsxs("div", { children: [
                        _jsx("label", { className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('aspectRatio') }),
                        _jsx("select", { value: aspectRatio, onChange: (e) => setAspectRatio(e.target.value), className: "w-full p-2 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-md text-light-text dark:text-dark-text", children: 
                           ASPECT_RATIOS.filter(r => r.value !== 'auto').map(ratio => (_jsx("option", { value: ratio.value, children: ratio.label[language] }, ratio.value)))
                         })] }),
                    _jsxs("div", { children: [
                        _jsx("label", { className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('outputFormat') }),
                        _jsxs("select", { value: outputFormat, onChange: (e) => setOutputFormat(e.target.value), className: "w-full p-2 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-md text-light-text dark:text-dark-text", children: [
                           ...
                           _jsx("option", { value: "image/webp", children: "WEBP" })] })] }),
                    _jsxs("div", { className: "flex items-center justify-between", children: [
                        _jsxs("label", { htmlFor: "beautify-toggle-creative", className: "block text-sm font-bold text-light-text dark:text-dark-text", children: [
                            t('beautify'),
                             !isBeautyAvailable && _jsxs("span", { className: "text-xs font-normal text-gray-500 ml-2", children: [t('beautifyHint')] })] }),
                        _jsx("label", { className: "relative inline-flex items-center cursor-pointer", children: [_jsx("input", { type: "checkbox", id: "beautify-toggle-creative", checked: beauty === 'on', onChange: (e) => setBeauty(e.target.checked ? 'on' : 'off'), className: "sr-only peer", disabled: !isBeautyAvailable }),
                            _jsx("div", { className: "w-11 h-6 bg-gray-200 rounded-full peer peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-light-primary/50 dark:peer-focus:ring-dark-primary/50 dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-light-primary dark:peer-checked:bg-dark-primary" })] })] }),
                    _jsxs("div", { children: [
                      _jsx("label", { htmlFor: "negativePrompt", className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('negativePrompt') }),
                      _jsx("textarea", { id: "negativePrompt", value: negativePrompt, onChange: (e) => setNegativePrompt(e.target.value), placeholder: t('negativePromptPlaceholder'), rows: 3, className: "w-full p-2 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-md text-light-text dark:text-dark-text" })] })] }),
                _jsxs("div", { className: "space-y-6", children: [
                    _jsxs("div", { className: "bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                         _jsx("h3", { className: "text-xl font-bold mb-4 text-light-text dark:text-dark-text", children: t('result') }),
                         _jsx("div", { className: "w-full h-96 bg-light-bg dark:bg-dark-bg rounded-lg flex items-center justify-center border border-light-border dark:border-dark-border", children: 
                             isLoading ? _jsx(Spinner, {}) : resultImage ? _jsx("img", { src: resultImage, alt: "Generated result", className: "object-contain max-h-full max-w-full rounded-lg" }) : _jsx("p", { className: "text-gray-500", children: t('preview') })
                          }),
                         error && _jsx("p", { className: "text-red-500 mt-4", children: error })] }),
                    resultImage && !isLoading && (
                        _jsxs("a", { href: resultImage, download: getDownloadFilename(resultImage), className: "w-full btn-primary text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center", children: [
...
const AIArchitect = ({ onBack }) => {
    ...
    return (
        _jsxs("div", { className: "p-4 md:p-8 animate-fade-in", children: [
            ...
            _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8", children: [
                _jsxs("div", { className: "space-y-6 bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                    _jsx(ToolInfo, { toolKey: "architect" }),
                    _jsx(ImageUploader, { label: t('uploadBlueprint'), onImageUpload: setBlueprintImage }),
                    _jsxs("div", { children: [
                        _jsx("label", { className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('preset') }),
                        _jsx("select", { value: preset, onChange: (e) => setPreset(e.target.value), className: "w-full p-2 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-md text-light-text dark:text-dark-text", children: 
                            Object.entries(PRESETS).filter(([key]) => key.startsWith('architecture-')).map(([key, value]) => (_jsx("option", { value: key, children: value.label[language] }, key)))
                         })] }),
                     _jsxs("div", { children: [
                        _jsx("label", { className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('aspectRatio') }),
                        _jsx("select", { value: aspectRatio, onChange: (e) => setAspectRatio(e.target.value), className: "w-full p-2 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-md text-light-text dark:text-dark-text", children: 
                ...
                _jsxs("div", { className: "space-y-6", children: [
                    _jsxs("div", { className: "bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                         _jsx("h3", { className: "text-xl font-bold mb-4 text-light-text dark:text-dark-text", children: t('result') }),
                         _jsx("div", { className: "w-full h-96 bg-light-bg dark:bg-dark-bg rounded-lg flex items-center justify-center border border-light-border dark:border-dark-border", children: 
                             isLoading ? _jsx(Spinner, {}) : resultImage && blueprintImage ? _jsx(ImageComparator, { beforeSrc: blueprintImage.dataUrl, afterSrc: resultImage }) : _jsx("p", { className: "text-gray-500", children: t('preview') })
                          }),
                         error && _jsx("p", { className: "text-red-500 mt-4", children: error })] }),
                    resultImage && !isLoading && (
                        _jsxs("a", { href: resultImage, download: getDownloadFilename(resultImage), className: "w-full btn-primary text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center", children: [
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (language === 'vi' && prompt.trim()) {
                finalPrompt = await callApi(() => translateText(prompt, 'Vietnamese', 'English'));
            }
            ...
            if (mode === 'image' && image && contextImage) {
                ...
                const compositeImageDataUrl = await callApi(() => generateImage(parts));
            ...
            const videoUrl = await callApi(() => generateVideo(finalPrompt, imageForVideoPayload, quality, aspectRatio));
    ...
    return (
        _jsxs("div", { className: "p-4 md:p-8 animate-fade-in", children: [
            ...
            _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8", children: [
                _jsxs("div", { className: "space-y-6 bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                    _jsxs("div", { children: [
                        _jsx("label", { className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('generationMode') }),
                        _jsxs("div", { className: "flex space-x-2 rounded-lg p-1 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border", children: [
                            _jsx("button", { onClick: () => setMode('text'), className: `w-full px-3 py-2 text-sm font-semibold rounded-md transition-colors duration-200 ${mode === 'text' ? 'btn-primary text-white' : 'bg-transparent text-light-text dark:text-dark-text'}`, children: 
                                t('textToVideo')
                             }),
                            _jsx("button", { onClick: () => setMode('image'), className: `w-full px-3 py-2 text-sm font-semibold rounded-md transition-colors duration-200 ${mode === 'image' ? 'btn-primary text-white' : 'bg-transparent text-light-text dark:text-dark-text'}`, children: 
                                t('imageToVideo')
                             })] })] }),

                    mode === 'image' && (
                        _jsxs(_Fragment, { children: [
                           _jsx(ImageUploader, { label: t('uploadCharacter'), onImageUpload: setImage }),
                           _jsx(ImageUploader, { label: t('uploadContext'), onImageUpload: setContextImage })] })
                    ),

                    _jsxs("div", { children: [
                      _jsx("label", { htmlFor: "videoPrompt", className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('videoPrompt') }),
                      _jsx("textarea", { 
                          id: "videoPrompt", 
                          value: prompt, 
                    ...
                    _jsxs("div", { children: [
                        _jsx("label", { className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('videoAspectRatio') }),
                        _jsxs("select", { 
                            value: aspectRatio, 
                            ...
                            children: [
                            _jsx("option", { value: "16:9", children: t('landscape') }),
                            _jsx("option", { value: "9:16", children: t('portrait') }),
                            _jsx("option", { value: "1:1", children: t('videoAspectSquare') })] })] }),

                    _jsxs("div", { children: [
                        _jsx("label", { className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('videoQuality') }),
                        _jsxs("select", { 
                            value: quality, 
                            ...
                            children: [
                            _jsx("option", { value: "720p", children: t('hd720') }),
                            _jsx("option", { value: "1080p", children: t('hd1080') })] })] })] }),
                _jsxs("div", { className: "space-y-6", children: [
                    _jsxs("div", { className: "bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                         _jsx("h3", { className: "text-xl font-bold mb-4 text-light-text dark:text-dark-text", children: t('videoResult') }),
                         _jsx("div", { className: "w-full aspect-video bg-light-bg dark:bg-dark-bg rounded-lg flex items-center justify-center border border-light-border dark:border-dark-border", children: 
                            isLoading ? (
                                _jsxs("div", { className: "text-center p-4", children: [
                                    _jsx(Spinner, {}),
                                    _jsx("p", { className: "mt-4 font-semibold text-light-text dark:text-dark-text", children: loadingMessage }),
                                    _jsx("p", { className: "text-sm text-gray-500", children: t('videoTakesTime') })] })
                             ) : resultVideo ? (
                                 _jsx("video", { src: resultVideo, controls: true, muted: true, playsInline: true, className: "w-full h-full rounded-lg" })
                             ) : (
                                _jsx("p", { className: "text-gray-500", children: t('videoWillAppear') })
                             )
                          }),
                         error && _jsx("p", { className: "text-red-500 mt-4 text-center", children: error })] }),
                    resultVideo && !isLoading && (
                        _jsxs("a", { href: resultVideo, download: "generated-video.mp4", className: "w-full btn-primary text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center", children: [
                            _jsx("i", { className: "fas fa-download mr-2" }), " ", t('download')] })
                    ),
                    _jsxs("button", { onClick: handleSubmit, disabled: isLoading, className: "w-full btn-primary text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed", children: [
                        _jsx("i", { className: "fas fa-film mr-2" }), " ", isLoading ? t('generatingVideo') : t('generateVideo')] })] })] })] })
    );
};
...
const AIMagic = ({ onBack }) => {
    ...
    return (
        _jsxs("div", { className: "p-4 md:p-8 animate-fade-in", children: [
            ...
            _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8", children: [
                _jsxs("div", { className: "space-y-6 bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                    _jsx(ToolInfo, { toolKey: "magic" }),
                    _jsx(ImageUploader, { label: t('uploadSourceImage'), onImageUpload: setSourceImage }),
                    
                    _jsxs("div", { children: [
                        _jsx("label", { htmlFor: "magic-positive-prompt", className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('positivePrompt') }),
                        _jsx("textarea", { 
                            ...
                            className: "w-full p-2 bg-light-bg dark:bg-dark-bg border border-light-border dark:border-dark-border rounded-md text-light-text dark:text-dark-text" })] }),
                    _jsxs("div", { children: [
                        _jsx("label", { htmlFor: "magic-negative-prompt", className: "block text-sm font-bold mb-2 text-light-text dark:text-dark-text", children: t('negativePrompt') }),
                        _jsx("textarea", { 
                    ...
                    _jsxs("div", { className: "space-y-4", children: [
                        _jsx(ToggleSwitch, { 
                         ...
                         _jsx(ToggleSwitch, { 
                            ...
                            disabled: isLoading }),
                        _jsx("hr", { className: "border-light-border dark:border-dark-border" }),
                         _jsx(ToggleSwitch, { 
                            id: "magic-preserve", 
                ...
                _jsxs("div", { className: "space-y-6", children: [
                    _jsxs("div", { className: "bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                         _jsx("h3", { className: "text-xl font-bold mb-4 text-light-text dark:text-dark-text", children: t('result') }),
                         _jsx("div", { className: "w-full h-96 bg-light-bg dark:bg-dark-bg rounded-lg flex items-center justify-center border border-light-border dark:border-dark-border", children: 
                             isLoading ? _jsx(Spinner, {}) : resultImage && sourceImage ? _jsx(ImageComparator, { beforeSrc: sourceImage.dataUrl, afterSrc: resultImage }) : _jsx("p", { className: "text-gray-500", children: t('preview') })
                          }),
                         error && _jsx("p", { className: "text-red-500 mt-4 text-center", children: error })] }),
                    resultImage && !isLoading && (
                        _jsxs("a", { href: resultImage, download: getDownloadFilename(resultImage), className: "w-full btn-primary text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center", children: [
                    ...
                    _jsxs("button", { onClick: handleSubmit, disabled: isLoading, className: "w-full btn-primary text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed", children: [
                        _jsx("i", { className: "fas fa-wand-magic-sparkles mr-2" }), " ", isLoading ? t('generating') : t('generate')] })] })] })] })
    );
};
...
const AIBackground = ({ onBack }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const finalPrompt = `
                [INSTRUCTION] Your only task is to strictly and cleanly remove the background from the provided image.
                - The subject must be perfectly isolated with clean, sharp edges.
                - The output format MUST be a PNG image with a fully transparent background.
                - Do not add any new elements, shadows, reflections, or backgrounds.
                - Preserve all details of the original subject.
            `;
    ...
    return (
        _jsxs("div", { className: "p-4 md:p-8 animate-fade-in", children: [
            ...
            _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8", children: [
                _jsxs("div", { className: "space-y-6 bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                    _jsx(ToolInfo, { toolKey: "background" }),
                    _jsx(ImageUploader, { label: t('uploadImage'), onImageUpload: setSourceImage })] }),
                _jsxs("div", { className: "space-y-6", children: [
                    _jsxs("div", { className: "bg-light-surface dark:bg-dark-surface p-6 rounded-lg shadow-md border border-light-border dark:border-dark-border", children: [
                         _jsx("h3", { className: "text-xl font-bold mb-4 text-light-text dark:text-dark-text", children: t('result') }),
                         _jsx("div", { className: "w-full h-96 bg-light-bg dark:bg-dark-bg rounded-lg flex items-center justify-center border border-light-border dark:border-dark-border checkerboard-bg", children: 
                             isLoading ? _jsx(Spinner, {}) : resultImage && sourceImage ? _jsx(ImageComparator, { beforeSrc: sourceImage.dataUrl, afterSrc: resultImage }) : _jsx("p", { className: "text-gray-500", children: t('preview') })
                          }),
                         error && _jsx("p", { className: "text-red-500 mt-4 text-center", children: error })] }),
                    resultImage && !isLoading && (
                    ...
                    _jsxs("button", { onClick: handleSubmit, disabled: isLoading || !sourceImage, className: "w-full btn-primary text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed", children: [
                        _jsx("i", { className: "fas fa-eraser mr-2" }), " ", isLoading ? t('generating') : t('generate')] })] })] })] })
    );
};

const Footer = () => {
  return (
    _jsx("footer", { className: "bg-light-surface dark:bg-dark-surface p-4 text-center border-t border-light-border dark:border-dark-border", children: 
      _jsx("p", { className: "text-sm text-gray-600 dark:text-gray-400", children: "©2025 Bản quyền thuộc về Dương Tiến Dũng 📱0917 939 111" })
     })
  );
};
...
const App = () => {
  ...
  const renderPage = () => {
    switch (page) {
      case 'pose':
        return _jsx(PoseStudio, { onBack: () => setPage('home') });
      case 'prop':
        return _jsx(PropFusion, { onBack: () => setPage('home') });
      case 'design':
        return _jsx(AIDesign, { onBack: () => setPage('home') });
      case 'creative':
        return _jsx(AICreative, { onBack: () => setPage('home') });
      case 'stylist':
        return _jsx(AIStylist, { onBack: () => setPage('home') });
      case 'architect':
        return _jsx(AIArchitect, { onBack: () => setPage('home') });
      case 'video':
        return _jsx(AIVideoCreator, { onBack: () => setPage('home') });
      case 'magic':
        return _jsx(AIMagic, { onBack: () => setPage('home') });
      case 'background':
        return _jsx(AIBackground, { onBack: () => setPage('home') });
      case 'home':
      default:
        return _jsx(HomePage, { onNavigate: handleNavigate });
    }
  };

  return (
    _jsx(AppContext.Provider, { value: contextValue, children: 
      _jsxs("div", { className: `min-h-screen flex flex-col bg-light-bg dark:bg-dark-bg text-light-text dark:text-dark-text transition-colors duration-300`, children: [
        _jsx(Header, {}),
        _jsx("main", { className: "flex-grow", children: renderPage() }),
        _jsx(Footer, {})] })
     })
  );
};
